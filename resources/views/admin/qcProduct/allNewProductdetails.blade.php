...
<div class="row my-3" style="margin: 0px 12px;">
    <div class="card container-fluid">
        <h2 class="text-left" style="padding: 30px 0px; text-transform: uppercase; color:#000000;"><b>Q.C New Product Details</b>&nbsp; &nbsp;  New Product</h2>
        {{--  error message  --}}
        @if ($errors->any())
            ...
            <div class="col">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 d-flex">
                            ...
                            <b>{{ @$allDetails->used_fabric }}</b> 
                            <label>Goj</label>
                        </div>
                        <div class="form-group col-md-6 d-flex">
                            <label for="altReceive_date"><b>Alternative Received Date</b></label>&nbsp; &nbsp; 
                            <b>{{ @date('d M Y',strtotime($allDetails->altReceive_date)) }}</b> 
                        </div>
                    </div>
            </div>
        </div>
