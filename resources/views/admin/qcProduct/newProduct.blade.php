...
<div class="row my-3" style="margin: 0px 12px;">
    ...
    <div class="m-4">
        <ul class="nav nav-tabs" id="myTab">
            ...
            <li class="nav-item">
                <a href="#profile" class="nav-link" data-toggle="tab">Alternative Product</a>
            </li>
        </ul>
    </div>
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="home">
            <div class="col">
                <form action="{{ route('qcNewProduct-store') }}" method="POST">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 d-flex">
                            <label for="used_fabric"><b>Used FAbric</b></label>&nbsp; &nbsp; 
                            <input style="width: 200px" type="number" class="form-control" name="used_fabric"  id="used_fabric"/>&nbsp; &nbsp; 
                            <label>Goj</label>
                        </div>
                        <div class="form-group col-md-6 d-flex">
                            <label for="altReceive_date"><b>Alternative Received Date</b></label>&nbsp; &nbsp; 
                            <input style="width: 200px" type="date" class="form-control" name="altReceive_date"  id="altReceive_date"/>
                        </div>

                        <div class="form-group col-md-12 d-flex">
                            <label for="fabric_name"><b>Q.C Manager Name</b></label>&nbsp; &nbsp; 
                            <b>{{ Auth::user()->name }}</b>
                        </div>
                        <div class="form-group col-md-12 text-center">
                            <button style="width: 200px" type="submit" class="btn btn-primary">Received</button>
                        </div>
                    </div>
                </form>
            </div>
